...
?>
    ...
    <div id="wrapper">
        ...
        <div class="container">
            ...
            <div class="row">
                <form action="/dashboard/call-add-post.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="order" id="exampleInputEmail1" placeholder="Enter order">
                    </div>

                    <button type="submit" class="btn btn-default">Add event call</button>
                </form>
            </div>
